...
public class TennisRepo {
    ...
    public PlayerStatistics getPlayerStatisticsByName(String playerName) {
        String sql = "with indwins as\n" +
                "(select * from atp_match_view where winner_name = ?),\n" +
                "indlosses as\n" +
                "(select * from atp_match_view where loser_name = ?)\n" +
                "\n" +
                "select\n" +
                "(select count(*) from atp_match_overview_view where winner_name = ?) career_wins,\n" +
                "(select count(*) from atp_match_overview_view where loser_name = ?) career_losses,\n" +
    ...
    public ArrayList<Match> getAllMatchesByPlayer(String playerName) {
        String sql = "select * from atp_match_overview_view\n" +
    ...
    public void calculateAllStatistics() {
        new ArrayList<String>(getAllPlayerNames()).forEach(pName -> {
            String sqlNumberMatches = "select * from atp_match_overview_view where winner_name = ? or loser_name = ?";
